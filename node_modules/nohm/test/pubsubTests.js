...
module.exports = {
  ...
  'initialized': {
    ...
    'create': function (t) {
      t.expect(5);
      var instance = nohm.factory('TesterCreate');
    ...
    'update': function (t) {
      t.expect(7);
      var instance = nohm.factory('TesterUpdate');
    ...
    'save': function (t) {
      t.expect(10);
      var instance = nohm.factory('TesterSave');
